...
def sep_equities(configpath=None):
    """
    ...
    return CSVDIRBundleSEP(configpath).ingest


class CSVDIRBundleSEP:
    """
...
@bundles.register("SEP", create_writers=False)
def sep_bundle(environ,
                  asset_db_writer,
                  minute_bar_writer,
                  daily_bar_writer,
                  adjustment_writer,
